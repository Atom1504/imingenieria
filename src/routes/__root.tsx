...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Empresa colombiana de ingeniería y construcción. Obras civiles, pisos industriales, bodegas industriales, silos, metalmecánica y alquiler de maquinaria. +20 años de experiencia." },
      ...
      { property: "og:description", content: "Empresa colombiana de ingeniería y construcción. Obras civiles, pisos industriales, bodegas industriales, silos, metalmecánica y alquiler de maquinaria. +20 años de experiencia." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "IM Ingeniería y Minerales S.A.S. — Construcción, Metalmecánica y Minería" },
      { name: "twitter:description", content: "Empresa colombiana de ingeniería y construcción. Obras civiles, pisos industriales, bodegas industriales, silos, metalmecánica y alquiler de maquinaria. +20 años de experiencia." },
